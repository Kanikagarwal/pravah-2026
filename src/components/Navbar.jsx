  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <div className="hidden md:flex space-x-8 items-center flex-grow justify-start">
            ...
            >
              HOME
              <span
                className={`absolute bottom-0 left-0 h-1 bg-[#5A3E36] rounded-full transition-all duration-500 group-hover:w-full ${
                  isActiveLink("/skit-pravah-2025") || isActiveLink("/")
                    ? "w-full"
                    : "w-0"
                }`}
              ></span>
            ...
            >
              ...
              <span
                className={`absolute bottom-0 left-0 h-1 bg-[#5A3E36] rounded-full transition-all duration-500 group-hover:w-full ${
                  isActiveLink("/skit-pravah-2025-events") ? "w-full" : "w-0"
                }`}
              ></span>
            </Link>
            <Link
            ...
            >
              ...
              <span
                className={`absolute bottom-0 left-0 h-1 bg-[#5A3E36] rounded-full transition-all duration-500 group-hover:w-full ${
                  isActiveLink("/skit-pravah-2025-AAVEG") ? "w-full" : "w-0"
                }`}
              ></span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex space-x-8 items-center flex-grow justify-end">
            ...
            >
              ...
              <span
                className={`absolute bottom-0 left-0 h-1 bg-[#5A3E36] rounded-full transition-all duration-500 group-hover:w-full ${
                  isActiveLink("/about-skit-pravah-2025") ? "w-full" : "w-0"
                }`}
              ></span>
            </Link>
            <Link
            ...
            >
              ...
              <span
                className={`absolute bottom-0 left-0 h-1 bg-[#5A3E36] rounded-full transition-all duration-500 group-hover:w-full ${
                  isActiveLink("/skit-pravah-2025-sponsors") ? "w-full" : "w-0"
                }`}
              ></span>
            </Link>
          </div>
          ...
          <button
            className="md:hidden text-[#FFF1B8] focus:outline-none text-3xl"
        ...
        {/* Mobile Menu */}
        <motion.div
          className={`md:hidden transition-all duration-500 bg-[#3d251e] ${
        ...
        >
          ...
          <button
            onClick={closeNavbar}
            className="absolute top-4 right-4 text-3xl text-[#FFF1B8] focus:outline-none"
          >
            &times;
          </button>
          ...
          <div className="flex flex-col items-center space-y-4 py-8">
            <Link
              to="/"
              className="text-lg font-medium text-[#FFF1B8] hover:text-yellow-600 transition pb-4"
            >
              HOME
            </Link>
            <Link
            ...
            <Link
              ...
              className="text-lg font-medium text-[#FFF1b8] hover:text-yellow-600 transition"
            >
              TEAM PRAVAH
            </Link>
      ...
      <motion.section
        className={`text-center mt-6 p-2  border-gray-200 sm:border-none ${
          eventName ? "block" : "hidden"
        } bg-white h-auto sm:bg-slate-100`}
        initial={{ opacity: 0, y: -50 }}
        animate={{ opacity: 1, y: 130 }}
        transition={{ duration: 1, ease: "easeOut" }}
      >
        <div className="relative">
          <motion.h1 className="text-3xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-black to-black font-sans tracking-tight">
            {eventName}
