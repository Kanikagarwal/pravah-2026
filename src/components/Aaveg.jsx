  ...
  return (
    <div className=" text-gray-900 relative overflow-hidden  ">
      <Helmet>
        ...
        <meta
          property="og:url"
          content="https://pravah.skit.ac.in/skit-pravah-2026-AAVEG"
        />
        <meta
          name="author"
      ...
      >
        ...
        <ParallaxProvider>
          <Parallax speed={-10}>
            <main className="min-h-screen flex flex-col items-center justify-center px-6 md:px-12 mt-32 relative">
              {/* Heading Section */}
              <motion.section
                    ...
                    filteredEvents.map((event, index) => (
                      ...
                      >
                        ...
                        <div className="flex flex-col justify-between p-3 leading-normal space-y-4 w-full">
                          <h5 className="text-xl font-bold text-[#f9eddd] tracking-tight text-center mt-2">
                            {event.eventName}
                          </h5>
                          <button
                            ...
                            onClick={() => {
                              setOpenModal(true);
                              setform(event.eventRegistrationLink);
                              setTitle(event.eventName);
                              setFees(event.eventFees);
                            }}
                          >
                            Join the Game
