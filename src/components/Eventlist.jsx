            ...
            <main className="min-h-screen flex flex-col items-center px-4 sm:px-6 md:px-0 mt-8 sm:mt-24 relative mb-72 gap-8">
              ...
              >
                {events.map((event) => (
                  <div
                    key={event._id}
                    className="flex flex-col items-center bg-[#5a3e36] rounded-lg sm:rounded-2xl overflow-hidden border hover:shadow-2xl transition-shadow duration-300 group shadow-sm sm:shadow-lg 
    w-full sm:w-[calc(33.33%-1rem)] md:w-[calc(25%-1rem)] lg:w-64 border-gray-300"
                  >
                    ...
                    <div className={`flex flex-col items-center w-full mt-4 `}>
                      <h5 className="text-sm sm:text-lg font-semibold text-[#f9eddd] transition-colors duration-300 font-sans text-center px-4">
                        {event.eventTitle}
                      </h5>
                    </div>
