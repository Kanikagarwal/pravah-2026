                      ...
                      >
                        <div className="flex items-center">
                          <h2 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-black to-black audiowide-regular">
                            {`DAY ${index + 1} - ${formatDayWithSuffix(day)}`}{" "}
                            Feb
                          </h2>
                        </div>
                            ...
                            >
                              <div className="relative bg-[#5a3e36] rounded-xl p-2 shadow-lg hover:shadow-2xl transition-all duration-300 group border border-black cursor-pointer">
                                ...
                                <div className="flex justify-between items-center mt-3 py-2">
                                  <h3 className="text-lg font-bold text-[#f9eddd] z-10 font-sans text-wrap hidden sm:block">
                                  ...
                                  <h3 className="text-sm font-bold text-black z-10 font-sans text-wrap sm:hidden">
                                    {event.eventTitle.length > 6
                                      ? `${event.eventTitle.substring(0, 6)}...`
                                      : event.eventTitle}
                                  </h3>

                                  <p className="text-sm text-[#2d201c] font-medium bg-[#f9eddd] px-2 py-1 rounded-lg">
