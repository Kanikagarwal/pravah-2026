...
const Eventdetails = () => {
  ...
  useEffect(() => {
    const fetchEventDetails = async () => {
      try {
        ...
        setError(
          "Failed to fetch event details. Please check your network connection."
        );
      } finally {
  ...
  startCountdown(
    event?.timerDate ? event?.timerDate : event?.eventDate,
    "countdown"
  );
  ...
  return (
    <div>
      ...
      <div
        className="w-screen min-h-screen p-0 z-50 overflow-x-hidden"
        style={{
            ...
            <main className="min-h-screen flex flex-col items-center px-6 md:px-12 mt-32 relative mb-40">
              ...
              {loading ? (
                <div className="w-full max-w-6xl mb-40">
                  <div className="flex flex-col items-center bg-[#5a3e36] rounded-lg shadow-lg overflow-hidden w-full border border-gray-200">
                ...
                <div className="flex flex-row gap-6 h-auto w-full justify-center">
                  {/* Left Card */}
                  <motion.div
                    className="relative flex flex-col md:flex-row items-center bg-gradient-to-r from-[#30211d] to-[#2d201c] rounded-2xl shadow-lg overflow-hidden w-full md:w-5/6 mb-16 transition-transform transform hover:scale-105 border border-gray-200 h-full m-auto"
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center md:items-start w-full md:w-1/2 p-8 space-y-6 h-full justify-stretch text-center md:text-left font-sans">
                      ...
                      <p className="text-lg text-[#f9eddd]">
                        ...
                        {formatTime(event?.eventTimings.to)}
                      </p>
                      <p className="text-lg text-[#f9eddd]">
                      ...
                      <p className="text-lg text-[#f9eddd]">
                        ...
                        {event?.additionalFields.length > 0 ? (
                          <span
                            className="bg-gray-200 px-2 text-gray-700 rounded-md font-medium border border-gray-500 ml-2 cursor-pointer"
                            onClick={() => setBottomteamdrawer(true)}
                          >
                            View
                          </span>
                        ) : (
         ...
         : (
            ...
            Register Now <FaArrowRight className="ml-2" />
                      ...
                      <div className="w-full mt-4">
                        <button
                          ...
                          className="bg-[#f9eddd] text-[#5a3e36] font-semibold w-full px-6 py-3 rounded-md shadow-lg flex justify-center items-center"
                        >
                    ...
                    {/* Right Card */}
                    <motion.div
                      className="w-full md:w-1/2 h-60 md:h-80 relative bg-gradient-to-r from-[#30211d] to-[#2d201c] p-4 border-l border-gray-400 rounded-r-lg border-dotted"
                    ...
                    >
                      <div className="border-b border-gray-300 pb-2 mb-4">
                        <h1 className="text-xl font-semibold text-[#f9eddd]">
                          Register
                        </h1>
                        <button
                          onClick={() => {
                          ...
                          className="absolute top-4 right-4 bg-[#f9eddd] text-[#5a3e36] font-medium text-sm px-3 py-1 rounded-lg  transition duration-300 border border-gray-300"
                        >
                          Copy Link
                        </button>
                      </div>
                      ...
                      {event?.erpLink && (
                        <>
                          {/* Registration Fee */}
                          <p className="text-lg text-[#5a3e36] mb-2 border rounded-xl p-3 opacity-100 bg-gradient-to-r from-[#f9eddd] to-[#FFF1B8]">
                          ...
                          <a
                            ...
                            className="relative inline-flex items-center justify-center px-6 py-3 font-semibold text-white bg-gradient-to-r from-[#f9eddd] to-[#FFF1B8] hover:from-[#f9eddd] hover:[#fff1b8] hover:to-[#f9eddd] rounded-xl shadow-md transition-transform focus:outline-none focus:ring focus:ring-offset-2 text-center space-x-3 w-full"
                          >
                            <span className="relative z-10 text-[#5a3e36]">Register Now</span>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="w-5 h-5 relative z-10 text-[#5a3e36]"
                              fill="none"
                              viewBox="0 0 24 24"
                              stroke="currentColor"
                              strokeWidth={2}
              ...
              >
                <h3 className="text-3xl font-extrabold text-[#5a3e36] text-center mb-10  relative font-sans  tracking-tight">
                  Event Description
                ...
                <motion.p className="text-2xl text-[#221815] leading-relaxed text-center font-sans">
                  <div
              ...
              <h2 className="text-3xl font-extrabold text-gray-800 text-center mb-3 mt-20 relative font-sans  tracking-tight">
                <motion.span
                  ...
                  className="relative inline-block text-[#5a3e36]"
                >
          ...
          >
            ...
            <Drawer.Header
              ...
              className="border-b border-[#f9eddd] text-[#f9eddd] font-semibold"
            />
            <Drawer.Items>
              {/* Main Content Area */}
              ...
              <div className="flex-grow overflow-y-auto px-0 py-6 scrollbar-hide ">
                ...
                <div className="relative">
                  ...
                  <button
                    onClick={handleShare}
                    className="text-[#5a3e36] text-2xl absolute top-2 right-2 bg-[#f9eddd] rounded-xl p-2 border border-gray-100 shadow-lg"
                  >
                    <FaShareAlt />
                  </button>
                </div>
                ...
                <div className="mt-6 space-y-5">
                  ...
                  <div className="flex justify-between items-center gap-4">
                    <h2 className="text-2xl font-semibold text-[#fff1b8] font-sans">
                      {event?.eventTitle}
                    </h2>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel=""
                    className="w-full px-6 py-3 text-center text-[#2d201c] bg-[#f9eddd] hover:bg-[#f8eee0] rounded-lg shadow-md transition-all duration-300 focus:outline-none focus:ring focus:ring-gray-600 flex justify-between align-middle items-center gap-2 font-normal"
                  >
                  ...
                  <div className="bg-[#f9eddd] p-3 rounded-lg border border-gray-300 shadow-sm mt-4">
                    <div className="flex items-center mb-2 justify-between">
                      <span className="text-sm font-medium text-[#2d201c]">
                        Date:
                      </span>
                    ...
                    <div className="flex items-center mb-2 justify-between mt-2 ">
                      ...
                      <p className="ml-2 text-sm text-[#2d201c]">
                        {event?.additionalFields.length > 0 ? (
                          <span
                            className="flex justify-center items-center gap-2 bg-gray-200 px-2 text-gray-700 rounded-md font-medium border border-gray-500"
                            onClick={() => setBottomteamdrawer(true)}
                          >
                            View
                          </span>
                ...
                <div className="bg-[#f9eddd] p-3 rounded-lg mt-4 shadow-lg w-full  border ">
                  <div className="text-justify">
                    <span className="text-[#2d201c] font-bold ">
                      Description :{" "}
                    </span>
                    <span
                      className="text-pretty text-justify text-sm mt-4 text-[#2d201c] font-sans font-normal"
                      dangerouslySetInnerHTML={{
                        __html:
                ...
                <div className="w-full max-w-sm rounded-xl mt-4 mb-20 border p-4 border-[#5a3e36] bg-[#f9eddd]">
                  {event?.eventCoordinators?.length > 0 ? (
                    <ul className="space-y-4">
                      {event.eventCoordinators.map((coordinator, index) => (
                        <li
                          key={index}
                          className="flex justify-between items-center bg-[#5a3e36] shadow-sm rounded-lg p-4"
                        >
                    ...
                    <p className="text-[#2d201c] text-center">
                ...
                <div className="flex justify-between items-center flex-col gap-4">
                  {event?.erpLink && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="relative px-6 py-3 font-semibold text-[#f9eddd] rounded-xl w-full text-center overflow-hidden flex justify-between items-center gap-2 text-md bg-opacity-30 backdrop-blur-md border border-black shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl"
                      style={{
                        backgroundImage:
                  ...
                  {!event?.erpLink && (
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-gradient-to-r from-[#5a3e36] to-[#5b3e36] opacity-30 animate-move-background"></div>
                    </a>
                  )}
                </div>
              </div>
          ...
          <Drawer
            ...
            position="bottom"
            style={{ zIndex: 20000 }}
            className="shadow-2xl border-t border-gray-300 rounded-t-2xl bg-white"
          >
          ...
          <Drawer
            open={bottomteamdrawer}
            onClose={() => setBottomteamdrawer(false)}
            position={isDesktop ? "right" : "bottom"}
            style={{ zIndex: 20000 }}
            className="shadow-2xl border-t border-gray-300 rounded-t-2xl sm:rounded-none bg-white h-m"
            backdrop={false}
          >
