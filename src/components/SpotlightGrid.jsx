...
const SpotlightGrid = () => {
        ...
        {(isOpen === null && isOpen !== false) ^ isOpen === true
          && (
            ...
            <motion.div
              ...
              exit={{ x: "-100%" }}
              className="flex absolute inset-0 bg-[radial-gradient(circle_at_bottom,#8A1F4D_0%,#B37B19_25%,#3A2F6B_50%,#000000_100%)]
                  
                  -z-10
                 
                  
  flex-col items-center h-screen z-50 justify-center overflow-hidden"
            >
              ...
              <h1 className="sm:text-5xl text-4xl font-extrabold text-white text-center animate__animated animate__bounceInDown mb-10">
                Get Ready to Meet
              </h1>
              ...
              <h1 className="sm:text-4xl text-3xl font-extrabold text-white tracking-wide text-center drop-shadow-[0_0_10px_rgba(255,255,255,0.6)]">Coming Soon...</h1>
  ...
  <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent 
                  opacity-0 group-hover:opacity-100 group-hover:scale-110 transition-all duration-700 flex items-end p-4 rounded-lg">
    <h2 className="text-white text-3xl font-bold drop-shadow-xl tracking-wide">
      Coming Soon
    </h2>
  </div>
  </div> }
